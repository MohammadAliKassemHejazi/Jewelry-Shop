        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <Card className="border-gray-200">
                <CardContent className="p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <label htmlFor="subject" className="block font-poppins text-sm font-medium text-gray-700 mb-2">
                        Subject *
                      </label>
                      <select
                        id="subject"
                        ...
                        onChange={handleInputChange}
                        className="w-full border border-gray-300 rounded-md px-3 py-2 focus:border-primary focus:ring-primary focus:outline-none font-poppins"
                      >
                    ...
                    <Button type="submit" size="lg" className="w-full bg-primary hover:bg-primary-dark text-white font-poppins">
                      Send Message
                    </Button>
                  </form>
                </CardContent>
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-playfair text-lg font-semibold text-gray-900 mb-1">Visit Our Boutique</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-playfair text-lg font-semibold text-gray-900 mb-1">Call Us</h3>
                      <p className="font-poppins text-gray-600">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-playfair text-lg font-semibold text-gray-900 mb-1">Email Us</h3>
                      <p className="font-poppins text-gray-600">
                        info@shimmerrose.com<br />
                        support@shimmerrose.com
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-playfair text-lg font-semibold text-gray-900 mb-1">Business Hours</h3>
                      <div className="font-poppins text-gray-600 space-y-1">
              ...
              {/* Social Media */}
              <div>
                <h3 className="font-playfair text-xl font-semibold text-gray-900 mb-4">Follow Us</h3>
